...
uniform highp mat4 modelMatrixCL3;
uniform highp mat4 ProjectionMatrix;

uniform mediump mat3 NormalMatrixCL3;
...
void main()
{
    ...
    //    mediump vec3 normal = normalize(NormalMatrixCL3 * Normal);
    ...
    wsInterpolatedNormal = normalize(NormalMatrixCL3 * Normal);
    wsInterpolatedEye = (vec3(EyePos) - (modelMatrixCL3 * Position).xyz);
    
    
    
    texCoordVarying = TexCoord;
    posVarying = modelMatrixCL3 * Position;
    normalVarying = normalize(NormalMatrixCL3 * Normal);
