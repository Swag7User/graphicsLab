...
uniform highp mat4 modelMatrixCL2;
uniform highp mat4 ProjectionMatrix;

uniform mediump mat3 NormalMatrixCL2;
...
void main()
{
    ...
    //    mediump vec3 normal = normalize(NormalMatrixCL2 * Normal);
    ...
    wsInterpolatedNormal = normalize(NormalMatrixCL2 * Normal);
    wsInterpolatedEye = (vec3(EyePos) - (modelMatrixCL2 * Position).xyz);
    
    
    
    texCoordVarying = TexCoord;
    posVarying = modelMatrixCL2 * Position;
    normalVarying = normalize(NormalMatrixCL2 * Normal);
