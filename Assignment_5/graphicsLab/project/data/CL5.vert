...
uniform highp mat4 modelMatrixCL5;
uniform highp mat4 ProjectionMatrix;

uniform mediump mat3 NormalMatrixCL5;
...
void main()
{
    ...
    //    mediump vec3 normal = normalize(NormalMatrixCL5 * Normal);
    ...
    wsInterpolatedNormal = normalize(NormalMatrixCL5 * Normal);
    wsInterpolatedEye = (vec3(EyePos) - (modelMatrixCL5 * Position).xyz);
    
    
    
    texCoordVarying = TexCoord;
    posVarying = modelMatrixCL5 * Position;
    normalVarying = normalize(NormalMatrixCL5 * Normal);
